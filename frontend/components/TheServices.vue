    ...
    <div class="container">
      <div class="row">
        <div class="col col-12 col-md-9 offset-md-1">
          ...
          <p class="services-subtitle">Придумываем концепции, планируем бюджет, пишем сценарии, снимаем и&nbsp;записываем, анимируем, рендерим и&nbsp;монтируем</p>
        </div>
      </div>
    </div>
